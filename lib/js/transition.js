      ...
      setTimeout(() => {
        ...
        sunVideo.src = isIOS()
          ? planet.includes("Earth")
            ? `https://res.cloudinary.com/dqr2et8oe/video/upload/v1730792400/r5bsfokf35wjfhkzlbvd.mov`
      ...
      setTimeout(() => {
        ...
        if (isIOS()) {
          if (planet.includes("Earth")) {
            sunVideo.innerHTML = `
              <source src="https://res.cloudinary.com/dqr2et8oe/video/upload/v1730792400/r5bsfokf35wjfhkzlbvd.mov">
            `;
          } else {
            sunVideo.innerHTML = `
              <source src="assets/globs/${planet.toLowerCase()}.hevc.mp4" type='video/mp4'>
            `;
          }
        } else {
          sunVideo.innerHTML = `
