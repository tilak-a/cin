...
function mySunFunc() {
  ...
  if (csection == 0) {
    ...
    if (is1020) {
      ...
      leftPosition = 50;
      bottomPosition = -55; // Adjusted higher for tablet
      scale = 0.9965811965811966; // Slightly smaller for tablet
    } else if (isTablet) {
      // Tablet specific values for section 0
      leftPosition = 50;
      bottomPosition = -30; // Adjusted higher for tablet
      scale = 0.8; // Slightly smaller for tablet
      sunVideo.style.width = "50%";
    } else if (ismobile) {
      leftPosition = 50;
      bottomPosition = -10; // Adjusted higher for tablet
      scale = 0.8; // Slightly smaller for tablet
      sunVideo.style.width = "50%";
    } else {
      // Desktop values (your existing values)
      leftPosition = 50.28490028490028;
      bottomPosition = -79.31623931623932;
      scale = 0.9965811965811966;
    }
