        ...
        if ($("div.sec-3").is(":visible")) {
          ...
          if (counter_circle_1 == 0) {
            ...
            $("video.myvideo2").attr("src", "images/Saturn.webm").animate(
              { left: "13px", top: "306px", width: "690px", display: "block" },
              {
                duration: 1000,
                queue: false,
                specialEasing: {
...
function mySunFunc() {
  ...
  const is1400 = window.matchMedia("(min-width: 1400px)").matches;
  ...
  if (csection == 0) {
    ...
    if (is1400) {
      leftPosition = 50.28490028490028;
      bottomPosition = -82.31623931623932;
      scale = 0.9965811965811966;
    } else if (is1020) {
      ...
      leftPosition = 50;
      bottomPosition = -20; // Adjusted higher for tablet
      scale = 0.8; // Slightly smaller for tablet
      sunVideo.style.width = "50%";
    } else {
      // Desktop values (your existing values)
      leftPosition = 50.28490028490028;
      bottomPosition = -88.31623931623932;
      scale = 0.9965811965811966;
    }
  ...
  if (
    ...
    let interpolatedTop = -50 + progressRatio * 30;
    if (window.innerHeight < 600) {
      interpolatedTop = -82 + progressRatio * 40;
    }
  ...
  if (csection == 1) {
    ...
    progress = Math.min(scrollProgress, 1);
    // leftPosition = 74.78632478632478;
    // bottomPosition = -10.512820512820511;
    // scale = 0.7025641025641025;

    // leftPosition = "50.28490028490028%";
    // sunVideo.style.bottom = "0%";
    // sunVideo.style.top = "10%";
    ...
    if (is1400) {
      ...
      // Desktop values (your existing values)
      leftPosition = 80.78632478632478;
      bottomPosition = -15.512820512820511;
      scale = 0.7025641025641025;
      sunVideo.style.width = "47%";
    }
